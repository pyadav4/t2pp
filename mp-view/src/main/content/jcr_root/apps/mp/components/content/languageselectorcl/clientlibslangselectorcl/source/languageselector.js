...
(function ($) {
    ...
    $.fn.languageSwitcher = function (op) {
        ...
        function init() {
            var selectedItem;
            var options = $("#" + rootElementId + " > span > select > option");
            if (isStaticWebSite) {
                var selectedId;
            ...
            $("#" + rootElementId + " span:first-child").remove();
        ...
        function toLiElement(option) {
            ...
            var text = $(option).text();
			 var classVal = $(option).attr("class");
            var liElement;
            if (isStaticWebSite) {
                var url = window.location.href;
                var page = url.substring(url.lastIndexOf("/")+1);
                var urlPage = 'http://' + document.domain + '/' + settings.pagePrefix + id + '/' + page;
                liElement = $("<li class=\"" + classVal + "\" ><a id=\"" + id + "\" href=\"" + urlPage + "\">" + text + "</a></li>");
            } else {
                ...
                liElement = $("<li class=\"" + classVal + "\" ><a id=\"" + id + "\" href=\"" + href + "\">" + text + "</a></li>");
            }
